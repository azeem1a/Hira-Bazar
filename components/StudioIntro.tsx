...
const processStages = [
  {
    ...
    title: "CONSULT",
    description:
      "We visit your space, understand your needs, and recommend the perfect curtain and window treatment solutions.",
  },
  {
    number: "02",
    title: "SELECT",
    description:
      "Browse our premium collection — from elegant drapes to Arabian curtains, PVC blinds, and wallpapers — and pick your style.",
  },
  {
    number: "03",
    title: "MEASURE",
    description:
      "Our experts precisely measure every window and door for a perfect, custom-fitted result down to the last millimetre.",
  },
  {
    number: "04",
    title: "INSTALL",
    description:
      "Professional installation by our skilled team, leaving your home looking beautiful with flawless, fitted curtains.",
  },
];
...
export default function StudioIntro() {
  ...
  return (
    <section
      ...
      aria-label="How We Work — The Hira Bazaar Process"
      style={{
    ...
    >
      <div className="mx-auto w-full max-w-[1340px] min-w-0">
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[480px] lg:max-w-[440px] aspect-[4/5] rounded-[22px] overflow-hidden shadow-xl" style={{ border: "1px solid rgba(183,140,74,0.18)" }}>
              <Image
                src="/images/hira_studio_fabric_workshop.png"
                alt="Hira Bazaar Curtain King — drapery showroom, fabric bolts, and tailoring studio in Mysuru"
                fill
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
              We visit your space, understand your needs, and find the right
              curtain and window treatment for you. From the first consultation
              to the final installation, every step is handled with care.
            </motion.p>
