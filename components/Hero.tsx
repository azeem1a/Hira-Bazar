...
const projectData: ProjectCardData = {
  chip: "Featured Collection",
  title: "Hira Bazaar",
  sub: "Curtains  \u00b7  Mysuru, Karnataka",
  year: "Window Showcase",
};
...
export default function Hero() {
  ...
  return (
    <section
      ...
      aria-label="Hero — Hira Bazaar Curtain King"
    >
      {/* Left forest glow */}
      <div
        aria-hidden="true"
      ...
      >
        ...
        <div className="relative" style={{ maxWidth: "580px" }}>
          ...
          >
            ...
            Premium Curtains &amp; Window Treatments · Mysuru
          </p>
          ...
          >
            Hira Bazaar Curtain King is your one-stop destination for premium
            curtains, elegant wallpapers, and custom window treatments in Mysuru.
          </p>
        ...
        >
          ...
          >
            ...
            <Image
              src="/images/hira_hero_luxury_living.jpg"
              alt="Hira Bazaar Curtain King — luxury living room with bespoke embroidered sheer curtains and chandelier in Mysuru, Karnataka."
              fill
              priority
