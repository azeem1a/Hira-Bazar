...
const LINDEN_IMAGES = [
  {
    src: "/images/hira_champagne_mirrored_lounge.jpg",
    alt: "Hira Bazaar Curtain King — Champagne gold drapes layered over translucent white sheers with custom tiebacks in Mysuru",
    title: "Champagne Drapes & Sheer Lace",
    objectPosition: "center center",
  },
  {
    src: "/images/hira_royal_embroidered_lace.png",
    alt: "Hira Bazaar Curtain King — Royal gold embroidered Arabian drapes with ornate floral sheers and rope tassels in Mysuru",
    title: "Royal Embroidered Drapes & Tassels",
    objectPosition: "center center",
  },
  {
    src: "/images/hira_ripple_pleat_marble.png",
    alt: "Hira Bazaar Curtain King — Contemporary ivory ripple-pleat curtains with dark marble flooring in Mysuru",
    title: "Tailored Ripple-Pleat Curtains",
    objectPosition: "center center",
  },
  {
    src: "/images/hira_passage_doorway_drapes.png",
    alt: "Hira Bazaar Curtain King — Bespoke passage and doorway drapes with designer pendant lighting in Mysuru",
    title: "Custom Passage & Doorway Drapes",
    objectPosition: "center center",
  },
  {
    src: "/images/hira_sunlit_bedroom_curtains.png",
    alt: "Hira Bazaar Curtain King — Sunlit master bedroom pinch-pleat curtains with matching fabric tieback cuffs in Mysuru",
    title: "Sunlit Master Bedroom Drapes",
    objectPosition: "center center",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          &ldquo;Mohammed Ismail and the Hira Bazaar team completely transformed
          our home. The Arabian curtains and sheer drapes are magnificent, and
          the fitting was flawless. Truly the Curtain King of Mysuru!&rdquo;
        </p>
        ...
        <div className="block md:hidden w-full min-w-0">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
              Every home has its own rhythm and light. We listen closely to your
              space, your style, and your privacy needs — crafting bespoke
              curtains and window treatments that feel effortlessly harmonious.
            </motion.p>
