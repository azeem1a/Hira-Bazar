...
const services: ServiceCard[] = [
  {
    variant: "image",
    number: "01",
    imageSrc: "/images/living_room_dual_drapes.jpg",
    imageAlt:
      "Hira Bazaar Curtain King — custom window and door curtains in Mysuru.",
    objectPosition: "center 35%",
    titleLines: ["Window & Door", "Curtains"],
    description:
      "Premium curtains for every window and door, crafted from quality fabrics and tailored to fit your space and style perfectly.",
    linkLabel: "Explore service",
  },
  {
    variant: "image",
    number: "02",
    imageSrc: "/images/hira_arabian_tassel_drapes.jpg",
    imageAlt:
      "Hira Bazaar Curtain King — tailored Arabian drapes with ornate tassel fringe trim and sheer curtains in Mysuru.",
    objectPosition: "center 22%",
    titleLines: ["Arabian Curtains", "& PVC Blinds"],
    description:
      "Elegant Arabian curtains and durable PVC blinds, including weather-resistant outdoor solutions built to last in any condition.",
    linkLabel: "Explore service",
  },
  {
    variant: "image",
    ...
    imageAlt:
      "Hira Bazaar Curtain King — luxury wallpapers, elegant drapes, and custom installation in Mysuru.",
    objectPosition: "center 30%",
    titleLines: ["Wallpapers &", "Installation"],
    description:
      "Transform your walls with our curated wallpaper collection, expertly measured and professionally installed by our team.",
    linkLabel: "Explore service",
  },
];
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden rounded-[24px] lg:rounded-[26px]">
        <Image
          ...
          style={{ objectPosition: card.objectPosition ?? "center 30%" }}
        />
      </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0" style={{ maxWidth: "560px" }}>
            ...
            <motion.p
              ...
              variants={fadeUp}
            >
              From first consultation to final installation, Hira Bazaar brings
              quality, craft, and care to every window and wall in your home.
            </motion.p>
          </div>
